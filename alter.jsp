...
<body>
	<div id="MAIN">
		...
		<br/>
		<P>PLEASE SELECT TIME TO SCHEDULE YOUR APPOINTMENT: </P>
		<form name="patform" action="http://localhost:8080/examples/jsp/jsp2/mine/alter.jsp" method="post">
			<p>Enter your e-mail id for confirmation:</p>
			<input name="pat" type="textbox" maxlength="30"></input>
			<br/>
			<p>Please Re-confirm the doctor's name:</p> 
			<input name="doc" type="textbox" maxlength="30"></input>
			<br/>
			<p>Please enter time for appointment:</p>
			<select  name="time">
...
if(rsd.next())
{
	if(t.equals("1"))
	{
		if(rsd.getString(5).equals("FREE"))
		{
	...
	if(t.equals("2"))
	{
		if(rsd.getString(6).equals("FREE"))
		{
	...
	if(t.equals("3"))
	{
		if(rsd.getString(7).equals("FREE"))
		{
	...
	if(t.equals("4"))
	{
		if(rsd.getString(8).equals("FREE"))
		{
	...
	if(t.equals("5"))
	{
		if(rsd.getString(9).equals("FREE"))
		{
	...
	if(t.equals("6"))
	{
		if(rsd.getString(10).equals("FREE"))
		{
	...
	if(t.equals("7"))
	{
		if(rsd.getString(11).equals("FREE"))
		{
	...
	if(t.equals("8"))
	{
		if(rsd.getString(12).equals("FREE"))
		{
...
<p>You have successfully scheduled your appointment! Have a nice day !</p>
<%
	}
}
else
{
%>
<p>You are trying to book in an already booked slot. Please try again. <a href="doc.jsp">Click here to schedule appointment again</a></p>
<%
}
%>
</div>
